...
export declare class TransactionController {
    ...
    initialize_wallet_funding(dto: FundWalletDTO, req: Request): Promise<{
        payment_url: string;
    ...
    hopper_withdrawal(hopper_id: string, dto: UpdateHopperDTO): Promise<import("@app/hoppers").Hopper>;
