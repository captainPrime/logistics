...
export declare class UserController {
    ...
    find_hopper(hopper_id: string, dto: UpdateHopperDTO): Promise<import("@app/hoppers").Hopper>;
    track_hopper(hopper_id: string, dto: UpdateHopperDTO): Promise<import("@app/hoppers").Hopper>;
    rate_hopper(hopper_id: string, dto: UpdateHopperDTO): Promise<import("@app/hoppers").Hopper>;
}
