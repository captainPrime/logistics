...
exports.VerifyPhoneDTO = exports.SendCodeDTO = void 0;
...
], SendCodeDTO.prototype, "phone_number", void 0);
exports.SendCodeDTO = SendCodeDTO;
class VerifyPhoneDTO {
    static _OPENAPI_METADATA_FACTORY() {
        return { phone_number: { required: true, type: () => String }, code: { required: true, type: () => String } };
    }
}
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
